...
setTimeout(()=>{
navigate("/success",{state:{message:"Deposit Successful"}});
},1200);
...
<h2 style={{marginBottom:"20px"}}>Deposit Money</h2>
...
image:{
flex:1,
backgroundImage:"url('https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?q=80&w=870')",
